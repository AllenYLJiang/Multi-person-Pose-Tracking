...
cur_python = '/root/anaconda3/envs/posewarper/bin/python'
working_dir = '/media/allenyljiang/Seagate_Backup_Plus_Drive/PoseWarper-main_ubuntu/'

### supplementary files
root_dir = '/media/allenyljiang/Seagate_Backup_Plus_Drive/PoseWarper-main_ubuntu/PoseWarper_supp_files/'

### directory with extracted and renamed frames
img_dir = '/media/allenyljiang/Seagate_Backup_Plus_Drive/Dataset/PoseTrack2018/'
...
pretrained_coco_model = root_dir + 'pretrained_models/PoseWarper_posetrack18.pth'
precomputed_boxes_file = root_dir + 'posetrack18_precomputed_boxes/test_boxes.json'
annot_dir = root_dir + 'posetrack18_annotation_dirs/val/'

###########
for jj in range(1, 2): ## train / inference
  V_list = [-1]
  N_list = [-1]
  for V in V_list: ## number of labeled videos
    for N in N_list: ## number of labeled frames per video
        ...
        inference_model_path = '/media/allenyljiang/Seagate_Backup_Plus_Drive/PoseWarper-main_ubuntu/PoseWarper_supp_files/pretrained_models/PoseWarper_posetrack18.pth'
        ...
        sfx = '/media/allenyljiang/Seagate_Backup_Plus_Drive/PoseWarper-main_ubuntu/PoseWarper_supp_files/pretrained_models/PoseWarper_posetrack18.pth'#'posetrack/pose_hrnet/w48_384x288_adam_lr1e-4/final_state.pth'
        inference_model_path = sfx#out_dir + sfx
        ...
        sfx = '/media/allenyljiang/Seagate_Backup_Plus_Drive/PoseWarper-main_ubuntu/PoseWarper_supp_files/pretrained_models/PoseWarper_posetrack18.pth'#'posetrack/pose_hrnet/w48_384x288_adam_lr1e-4_PoseWarper_train/final_state.pth'
        pose_warper_model_path = sfx#out_dir + sfx
        if jj == 1:
